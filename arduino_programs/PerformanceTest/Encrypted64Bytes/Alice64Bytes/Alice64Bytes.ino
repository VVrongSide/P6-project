...
void transmitMessage(bool firstNonce) {
  ...
  if (firstNonce) {
    ...
    uint8_t micInput[67] = {header_b1, header_b2, header_b3,(uint8_t)payload >> 504, (uint8_t)payload >> 496, (uint8_t)payload >> 488, (uint8_t)payload >> 480, (uint8_t)payload >> 472, (uint8_t)payload >> 464, (uint8_t)payload >> 456, (uint8_t)payload >> 448, (uint8_t)payload >> 440, (uint8_t)payload >> 432, (uint8_t)payload >> 424, (uint8_t)payload >> 416, (uint8_t)payload >> 408, (uint8_t)payload >> 400, (uint8_t)payload >> 392, (uint8_t)payload >> 384, (uint8_t)payload >> 376, (uint8_t)payload >> 368, (uint8_t)payload >> 360, (uint8_t)payload >> 352, (uint8_t)payload >> 344, (uint8_t)payload >> 336, (uint8_t)payload >> 328, (uint8_t)payload >> 320, (uint8_t)payload >> 312, (uint8_t)payload >> 304, (uint8_t)payload >> 296, (uint8_t)payload >> 288, (uint8_t)payload >> 280, (uint8_t)payload >> 272, (uint8_t)payload >> 264, (uint8_t)payload >> 256, (uint8_t)payload >> 248, (uint8_t)payload >> 240, (uint8_t)payload >> 232, (uint8_t)payload >> 224, (uint8_t)payload >> 216, (uint8_t)payload >> 208, (uint8_t)payload >> 200, (uint8_t)payload >> 192, (uint8_t)payload >> 184, (uint8_t)payload >> 176, (uint8_t)payload >> 168, (uint8_t)payload >> 160, (uint8_t)payload >> 152, (uint8_t)payload >> 144, (uint8_t)payload >> 136, (uint8_t)payload >> 128, (uint8_t)payload >> 120, (uint8_t)payload >> 112, (uint8_t)payload >> 104, (uint8_t)payload >> 96, (uint8_t)payload >> 88, (uint8_t)payload >> 80, (uint8_t)payload >> 72, (uint8_t)payload >> 64, (uint8_t)payload >> 56, (uint8_t)payload >> 48, (uint8_t)payload >> 40, (uint8_t)payload >> 32, (uint8_t)payload >> 24, (uint8_t)payload >> 16, (uint8_t)payload >> 8, (uint8_t)payload};
...
//  Serial.println(uint32_t(msgKey[0]));
  ...
  payload[8] = payload[8] ^   (uint16_t)(msgKey[0] >> 48);
  payload[9] = payload[9] ^   (uint16_t)(msgKey[0] >> 32);
  payload[10] = payload[10] ^ (uint16_t)(msgKey[0] >> 16);
  payload[11] = payload[11] ^ (uint16_t)msgKey[0];
  payload[12] = payload[12] ^ (uint16_t)(msgKey[1] >> 48);
  payload[13] = payload[13] ^ (uint16_t)(msgKey[1] >> 32);
  payload[14] = payload[14] ^ (uint16_t)(msgKey[1] >> 16);
  payload[15] = payload[15] ^ (uint16_t)msgKey[1];

  getMsgKey(msgKey);

  payload[16] = payload[16] ^ (uint16_t)(msgKey[0] >> 48);
  payload[17] = payload[17] ^ (uint16_t)(msgKey[0] >> 32);
  payload[18] = payload[18] ^ (uint16_t)(msgKey[0] >> 16);
  payload[19] = payload[19] ^ (uint16_t)msgKey[0];
  payload[20] = payload[20] ^ (uint16_t)(msgKey[1] >> 48);
  payload[21] = payload[21] ^ (uint16_t)(msgKey[1] >> 32);
  payload[22] = payload[22] ^ (uint16_t)(msgKey[1] >> 16);
  payload[23] = payload[23] ^ (uint16_t)msgKey[1];

  getMsgKey(msgKey);

  payload[24] = payload[24] ^ (uint16_t)(msgKey[0] >> 48);
  payload[25] = payload[25] ^ (uint16_t)(msgKey[0] >> 32);
  payload[26] = payload[26] ^ (uint16_t)(msgKey[0] >> 16);
  payload[27] = payload[27] ^ (uint16_t)msgKey[0];
  payload[28] = payload[28] ^ (uint16_t)(msgKey[1] >> 48);
  payload[29] = payload[29] ^ (uint16_t)(msgKey[1] >> 32);
  payload[30] = payload[30] ^ (uint16_t)(msgKey[1] >> 16);
  payload[31] = payload[31] ^ (uint16_t)msgKey[1];
